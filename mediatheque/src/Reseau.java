...
public class Reseau {
	...
	public static void main(String[] args){
		...
		Ouvrage feeCarabine = media1.ajouterProduit("La Fée carabine", "1987", "L'inspecteur de police Vanini faisait un tour de quartier quand il est tué par une vieille dame maniant un P38...", "Gallimard", "2-07-040370-X", TypeOuvrage.Roman,pennac);
